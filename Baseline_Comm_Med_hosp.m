    ...
    for upsilon0=upsilonarr
        ...
        if upsilon0==0 %plot 
            ...
            if i1==1
                ...
                figure(10);
                subplot(1,3,1);
                h10(1)=plot(t,hosp,'-.','color',novacc,'LineWidth',4);hold on;
            else
                figure(6);
                subplot(1,3,2);
        ...
        elseif upsilon0==upsilonarr(2)
            if i1==1 %variant type
                ...
                figure(10);
                subplot(1,3,1);
                h10(2)=plot(t,hosp,'color',col_p(1,:),'LineWidth',4);hold on;
                ...
                figure(11);% v1, slow
                subplot(1,3,1);
                h11(2)=area(t,cum_hosp,'facecolor',novacc,'edgecolor','none');hold on;
                ...
                figure(11);% v2, slow
                subplot(1,3,2);
                h11(4)=area(t,cum_hosp,'facecolor',novacc,'edgecolor','none');hold on;
            ...
            if i1==1
                ...
                figure(10);
                subplot(1,3,1);
                h10(3)=plot(t,hosp,'color',col_p(2,:),'LineWidth',4);hold on;
               ...
               figure(12);% v1, fast
               subplot(1,3,1);
               h12(2)=area(t,cum_hosp,'facecolor',novacc,'edgecolor','none');hold on;
               ...
               ylim([0,2]);
                ...
                figure(12);% v2, fast
                subplot(1,3,2);
                h12(4)=area(t,cum_hosp,'facecolor',novacc,'edgecolor','none');hold on;
...
%         h8(3)=area(t,100*cumvacc/popOut,'facecolor',medblue,'edgecolor','none');hold on;
        ...
        figure(11);% v1, slow
        subplot(1,3,3);
        area(t,cum_hosp,'facecolor',novacc,'edgecolor','none');hold on;
    ...
    for upsilon0=upsilonarr(2:3)
        ...
        if upsilon0==upsilonarr(2)
            if i1==1
                ...
                figure(10);
                subplot(1,3,1);
                h10(4)=plot(t,hosp,'-','color',col_p2(1,:),'LineWidth',4);hold on;
            else
                figure(6);
                subplot(1,3,2);
            ...
            if i1==1
                ...
                figure(10);
                subplot(1,3,1);
                h10(5)=plot(t,hosp,'-','LineWidth',4,'color',col_p2(2,:));hold on;
            else
                figure(6);
                subplot(1,3,2);
...
figure(10);annotation('textbox', [0.05, 0.99, 0, 0], 'string', 'g','FontWeight','bold','FontSize',30)
figure(10);annotation('textbox', [0.35, 0.99, 0, 0], 'string', 'h','FontWeight','bold','FontSize',30)
figure(10);annotation('textbox', [0.66, 0.99, 0, 0], 'string', 'i','FontWeight','bold','FontSize',30)
